...
export const dashboardCopy = {
  ar: {
    client: {
      ...
      nav: ["الرئيسية", "طلب جديد", "طلباتي", "المتاجر", "سوق الخامات", "المفضلين", "المحفظة", "الإعدادات"],
    ...
    worker: {
      ...
      nav: ["الرئيسية", "صفحتي الشخصية", "طلبات واردة", "نشطة", "الأرباح", "حملات الترويج", "التقييمات", "الإعدادات"],
    ...
    vendor: {
      ...
      nav: ["الرئيسية", "طلبات البضائع", "الطلبات الجارية", "مزايدة الخامات", "المخزون", "الإعلانات الترويجية", "المحفظة", "الإعدادات"],
    ...
    admin: {
      ...
      nav: ["الرئيسية", "إدارة الصنايعية", "العملاء", "الطلبات", "المتاجر", "قائمة الانتظار", "المالية", "إدارة الإعلانات", "التسعير والأسعار", "إدارة الخدمات", "المعرض", "الصور الشخصية", "الإعدادات"],
  ...
  en: {
    client: {
      ...
      nav: ["Home", "New Request", "My Requests", "Stores", "Materials Market", "Favorites", "Wallet", "Settings"],
    ...
    worker: {
      ...
      nav: ["Home", "Public Profile", "Incoming", "Active", "Earnings", "Sponsored Ads", "Ratings", "Settings"],
    ...
    vendor: {
      ...
      nav: ["Home", "Material Requests", "Active Orders", "Material Bidding", "Inventory", "Promo Ads", "Wallet", "Settings"],
    ...
    admin: {
      ...
      nav: ["Home", "Workers Management", "Clients", "Requests", "Vendors", "Waitlist", "Finance", "Ads Manager", "Pricing & Plans", "Services Manager", "Media", "Avatar Library", "Settings"],
