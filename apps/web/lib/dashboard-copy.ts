...
export const dashboardCopy = {
  ar: {
    ...
    admin: {
      ...
      nav: ["الرئيسية", "توثيق العمال", "العملاء", "الطلبات", "المتاجر", "الصنايعية", "المالية", "إدارة الإعلانات", "التسعير والأسعار", "إدارة الخدمات", "المعرض", "الصور الشخصية", "الإعدادات"],
  ...
  en: {
    ...
    admin: {
      ...
      nav: ["Home", "Worker Verification", "Clients", "Requests", "Vendors", "Workers", "Finance", "Ads Manager", "Pricing & Plans", "Services Manager", "Media", "Avatar Library", "Settings"],
