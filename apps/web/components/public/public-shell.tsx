...
export function PublicFooter({ locale }: { locale: Locale }) {
  ...
  return (
    <footer className="mt-auto w-full border-t border-white/10 bg-[#1a1c1c] py-8 text-white">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 px-4 md:px-12 max-w-7xl mx-auto text-start">
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              aria-label="Facebook"
              className="inline-flex h-8 w-8 items-center justify-center border border-white/10 bg-white/5 text-neutral-400 hover:text-gold hover:border-gold transition-colors"
            >
        ...
        <div>
          <h5 className="text-gold font-bold text-sm uppercase mb-3">{isArabic ? "الشركة" : "Company"}</h5>
        ...
        <div>
          ...
          <ul className="space-y-2 text-neutral-400 text-sm">
            ...
            <li><Link href={`/${locale}/billing`} className="hover:text-white transition-colors">{isArabic ? "سياسة الاشتراكات" : "Billing Policy"}</Link></li>
            <li><Link href={`/${locale}/contact`} className="hover:text-white transition-colors">{isArabic ? "اتصل بنا" : "Contact Support"}</Link></li>
          </ul>
        </div>
        <div>
          <h5 className="text-gold font-bold text-sm uppercase mb-3">{isArabic ? "الشروط" : "Legal"}</h5>
          <ul className="space-y-2 text-neutral-400 text-sm">
      ...
      <div className="mt-6 pt-4 px-4 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2 text-neutral-400 text-xs border-t border-white/10">
        <span>
