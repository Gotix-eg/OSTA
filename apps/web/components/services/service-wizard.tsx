...
export function ServiceWizard({ locale, category }: { locale: Locale; category: ServiceCategory }) {
  ...
  return (
    <div className="min-h-screen bg-gold-500" dir={dir}>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-[300px_1fr]">
          ...
          <aside className="space-y-4">
            ...
            {/* Progress steps */}
            <div className="rounded-[2rem] bg-white p-6 shadow-xl shadow-black/5 border border-gold-600/10">
          ...
          <main>
            <AnimatePresence mode="wait">
              <motion.div key={step}
                ...
                className="rounded-[2.5rem] bg-white p-8 shadow-2xl shadow-black/5 border border-gold-600/10 sm:p-12"
              >
                {/* Step: Job Type */}
                {step === "job-type" && (
                        ...
                        return (
                          ...
                          >
                            <div className={cn(
                              ...
                              selected ? "border-white bg-gray-900" : "border-gray-200 group-hover:border-gray-400"
                            )}>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={cn(
                              ...
                              selected ? "border-white bg-gray-900" : "border-gray-200"
                            )}>
                              {selected && <div className="h-2.5 w-2.5 rounded-full bg-gray-900" />}
                            </div>
                          </button>
