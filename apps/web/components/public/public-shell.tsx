          ...
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 border-b border-white/5 pb-12">
            ...
            <div className="flex flex-col gap-6 lg:col-span-2">
              ...
              <div className="flex flex-col gap-3.5 text-xs font-semibold tracking-wide text-onyx-400">
                <a href="https://wa.me/201009410112" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 hover:text-gold-500 transition-colors w-fit">
                  <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current text-gold-500" xmlns="http://www.w3.org/2000/svg">
