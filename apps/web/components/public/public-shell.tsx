          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                aria-label="Facebook"
                className="inline-flex h-10 w-10 items-center justify-center border border-white/10 bg-white/5 text-neutral-400 hover:text-[#f5bd18] hover:border-[#f5bd18] transition-colors"
              >
