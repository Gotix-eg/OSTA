...
const CRAFTS = [
  ...
  { id: "ac", name: { ar: "التكييفات", en: "AC Maintenance" }, image: "https://images.unsplash.com/photo-1631543533910-d1901dd59659?w=800&auto=format&fit=crop&q=80", color: "from-cyan-400 to-cyan-600" },
  { id: "appliances", name: { ar: "صيانة أجهزة", en: "Home Appliances" }, image: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&auto=format&fit=crop&q=80", color: "from-purple-400 to-purple-600" },
  { id: "painting", name: { ar: "الدهانات", en: "Painting" }, image: "https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=800&auto=format&fit=crop&q=80", color: "from-rose-400 to-rose-600" },
  { id: "aluminum", name: { ar: "الوميتال", en: "Aluminum" }, image: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?w=800&auto=format&fit=crop&q=80", color: "from-slate-400 to-slate-600" },
  { id: "networks", name: { ar: "الشبكات", en: "Networks" }, image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&auto=format&fit=crop&q=80", color: "from-indigo-400 to-indigo-600" },
  { id: "computer", name: { ar: "صيانة كمبيوتر", en: "Computer" }, image: "https://images.unsplash.com/photo-1588508065123-287b28e013da?w=800&auto=format&fit=crop&q=80", color: "from-emerald-400 to-emerald-600" },
  { id: "cameras", name: { ar: "تركيب كاميرات", en: "CCTV" }, image: "https://images.unsplash.com/photo-1557597774-9d2739f85a76?w=800&auto=format&fit=crop&q=80", color: "from-red-400 to-red-600" },
];
