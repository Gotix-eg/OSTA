...
export const dashboardCopy = {
  ar: {
    ...
    worker: {
      ...
      nav: ["الرئيسية", "طلبات واردة", "نشطة", "الأرباح", "حملات الترويج", "التقييمات", "صفحتي الشخصية", "الإعدادات"],
  ...
  en: {
    ...
    worker: {
      ...
      nav: ["Home", "Incoming", "Active", "Earnings", "Sponsored Ads", "Ratings", "Public Profile", "Settings"],
