...
export function PublicShell({ locale, pathname, children }: { locale: Locale; pathname: string; children: ReactNode }) {
  ...
  return (
    <main className="min-h-screen bg-[#f9f9f9] text-[#1a1c1c] selection:bg-gold selection:text-[#1a1c1c] max-md:bg-gold">
      ...
      {/* Footer */}
      <footer className="mt-auto hidden w-full border-t border-white/10 bg-[#1a1c1c] py-8 text-white md:block">
        ...
        <div className="mt-6 pt-4 px-4 md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2 text-neutral-400 text-xs">
          <span>
