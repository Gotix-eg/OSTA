...
export const dashboardCopy = {
  ar: {
    ...
    admin: {
      ...
      nav: ["الرئيسية", "إدارة الصنايعية", "العملاء", "الطلبات", "المتاجر", "المالية", "إدارة الإعلانات", "التسعير والأسعار", "إدارة الخدمات", "المعرض", "الصور الشخصية", "الإعدادات"],
  ...
  en: {
    ...
    admin: {
      ...
      nav: ["Home", "Workers Management", "Clients", "Requests", "Vendors", "Finance", "Ads Manager", "Pricing & Plans", "Services Manager", "Media", "Avatar Library", "Settings"],
