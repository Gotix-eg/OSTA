...
const CRAFTS = [
  ...
  { id: "plumbing", name: { ar: "السباكة", en: "Plumbing" }, image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?q=80&w=800&auto=format&fit=crop", color: "from-blue-400 to-blue-600" },
  { id: "carpentry", name: { ar: "النجارة", en: "Carpentry" }, image: "https://images.unsplash.com/photo-1497219055242-93359eeed651?q=80&w=800&auto=format&fit=crop", color: "from-amber-600 to-amber-800" },
  { id: "ac", name: { ar: "التكييفات", en: "AC Maintenance" }, image: "https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?q=80&w=800&auto=format&fit=crop", color: "from-cyan-400 to-cyan-600" },
