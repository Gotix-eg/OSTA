...
export const dashboardCopy = {
  ar: {
    ...
    admin: {
      ...
      nav: ["الرئيسية", "توثيق العمال", "العملاء", "الطلبات", "المالية", "إدارة الإعلانات", "التسعير والأسعار", "الإعدادات"],
  ...
  en: {
    ...
    admin: {
      ...
      nav: ["Home", "Worker Verification", "Clients", "Requests", "Finance", "Ads Manager", "Pricing & Plans", "Settings"],
